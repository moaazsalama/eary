...
router.get('/answer',(req, res)=> {
  ...
  //save all data
  router.post('/answer',adminAuth, (req, res)=> {
    const data=req.body;
    conn.query("insert into answers set ?",
    {/*id:1,*/ answer1:data.answer1, answer2:data.answer2,answer3:data.answer3,answer4:data.answer4,validAnswer:data.validAnswer},
    (err,result,fields)=>{
        if(err)
        {
            res.statusCode=400;
